...
open class WhisperView: UIView {
    ...
    open lazy var titleLabel: UILabel = {
        ...
        label.frame.size.width = UIScreen.main.bounds.width / 3.0 - 60
    ...
    init(height: CGFloat, message: Message) {
        ...
        frame = CGRect(x: UIScreen.main.bounds.width / 3.0, y: height, width: UIScreen.main.bounds.width / 3.0, height: Dimensions.height)
